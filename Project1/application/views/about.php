    ...
    <div class="content">
    	<div class="section group">
				<div class="col_1_of_3 span_1_of_3">
					<h3>Who We Are........</h3>
					<img src=<?= base_url('asset/images/about_img.jpg')?> alt="">
				...
				<div class="col_1_of_4 span_1_of_4">
					<h4>Contact</h4>
						...
						<div class="social-icons">
							<h4>Follow Us</h4>
					   		  <ul>
							      <li><a href="#" target="_blank"><img src=<?= base_url('asset/images/facebook.jpg')?> alt="" /></a></li>
							      ...
							      <li><a href="#" target="_blank"><img src=<?= base_url('asset/images/dribbble.jpg')?> alt="" /></a></li>
